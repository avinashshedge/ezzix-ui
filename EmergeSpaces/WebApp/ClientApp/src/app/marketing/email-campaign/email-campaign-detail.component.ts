...
@Component({
  selector: 'email-campaign-detail',
...
export class EmailCampaignDetailComponent implements OnInit {
  ...
  displayedColumns = ['fullName', 'mobileNumber','emailId','delivered','opened','clicked'];
  ...
  getCampaignDetails(){
    this.marketingService.getEmailCampaign(this.campaignId).subscribe(res => {
      this.campaign = res;
